...
Then create the script `scripts/07-november_2023-bacteria.R` and add stuff using targets:
...
```r
Sys.setenv(TAR_PROJECT = "november_2023-bacteria")
```
...
PROJECTS := technical_replicates plot_iNEXT reactor_vs_algae duckweed_and_box november_2023-bacteria
```
